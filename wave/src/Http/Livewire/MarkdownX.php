...
class MarkdownX extends Component
{
    ...
    protected $listeners = [
        ...
        'markdown-x-fetch-content' => 'fetchContent'
    ];
     ...
     * @return void
     */
    public function mount($content = '', $name = '', $key = 'markdownx-editor'){
    ...
    */
    public function update($data){
        ...
        $this->content = $content;
        $this->dispatch('markdown-x:update', content: $this->content);
    }
    ...
    /**
     * Used for the parent component to emit `markdown-x-fetch-content` event
     * and specify a callback event to receive the updated content.
     *
     */
    public function fetchContent($callback){
        $this->dispatch($callback, content: $this->content);
    }
