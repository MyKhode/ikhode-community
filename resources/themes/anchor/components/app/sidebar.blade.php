        ...
        <div class="flex flex-col justify-between w-full overflow-auto md:h-full h-svh pt-4 pb-2.5">
            <div class="relative flex flex-col">
                ...
                <div class="flex flex-col justify-start items-center px-4 space-y-1.5 w-full h-full text-slate-600 dark:text-zinc-400">
                    ...
                    <x-app.sidebar-link href="/discussions" icon="phosphor-hand-peace" :active="Request::is('discussions')">Community</x-app.sidebar-link>
                    <x-app.sidebar-link href="/profile/{{ auth()->user()->username }}" icon="phosphor-planet" :active="Request::is('profile/')">Public Profile</x-app.sidebar-link>
                    <x-app.sidebar-link href="/notifications" icon="phosphor-bell" :active="Request::is('notifications')">Notifications</x-app.sidebar-link>
